...
class StackTraceUtilsTest {
    ...
    private final Set<Method> stackTraceUtilsTestMethods =
...
//        StackTraceUtils.setStackTraceSupplier();
    ...
    @Test
    void getStackTraceMethodsTest(final TestInfo testInfo) {
        final Set<Method> methods = StackTraceUtils.getStackTraceMethods(
            StackTraceUtils.withAnnotations(
                Test.class
            ));
