...
import static com.tatumalenko.algorithms.java.leetcode.FlattenBinaryTreeToLinkedList114.TreeNode;
...
class FlattenBinaryTreeToLinkedList114Test {
    ...
    void test(final TreeNode input, final TreeNode expected) {
